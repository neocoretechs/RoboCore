...
public class AuxPWMControl {
	 ...
	 * @param marlinspikeControlInterface. The AsynchDemuxer
	 ...
	 */
	public void activateAux(MarlinspikeControlInterface marlinspikeControlInterface, int[] pinaction) throws IOException {
		marlinspikeControlInterface.commandPWM("M45 P"+String.valueOf(pinaction[0])+" S"+String.valueOf(pinaction[1]));
	}
}