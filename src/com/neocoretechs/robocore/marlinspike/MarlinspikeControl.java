...
public class MarlinspikeControl implements MarlinspikeControlInterface {
	 ...
	 * open source serial library and its own read and write threads, or processes the return from the MarlinspikeDataPort.<p>
    ...
    public synchronized void getControllerStatus() throws IOException {
			if(DEBUG)
				System.out.println(this.getClass().getName()+".reportAllControllerSatus");
