...
public class lineseq implements Runnable {
	...
	public lineseq(AsynchDemuxer asynchDemuxer, Map<String, TopicList> topics) {
		...
		// LINESEQ error
		//
		this.topicList = new TopicList(asynchDemuxer, topicNames.LINESEQ.val(), 2) {
			@Override
		...
		topics.put(topicNames.LINESEQ.val(), topicList);
	}
	@Override
	public void run() {
		while(shouldRun) {
